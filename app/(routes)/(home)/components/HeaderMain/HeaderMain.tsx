...
export default function HeaderMain(props: DataHeaderMainProps) {
    const { userId } = props;
            ...
            <Dialog open={openDialog} onOpenChange={setOpenDialog}>
                <DropdownMenu open={openDropdown} onOpenChange={setOpenDropdown}>
                    <DropdownMenuTrigger asChild>
                        <Button className="bg-green-800 hover:bg-green-700 focus:ring-green-600">
                            New <ChevronDown />
                        </Button>
                    </DropdownMenuTrigger>
                        ...
                        <DropdownMenuLabel>
                            <DialogTrigger asChild>
                                <div className="flex flex-col">
                                    {dataHeaderMain.map(({ text, icon: Icon, typeElement }) => (
